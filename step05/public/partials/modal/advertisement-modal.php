<link href="<?=_ROOT_URL_?>/public/assets/css/advertisement-modal.css" rel="stylesheet">

<div class="modal fade" id="advertisementModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
    <div class="modal-content" id="ad-modal">
        <div class="modal-header" id="ad-modal_header">
        <h5 class="modal-title" id="exampleModalLabel">Modal title</h5>
        <button type="button" id="close-ad-modal" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        ...
        <p class="card-text" id="ad-modal-content">
        ...
        <div class="modal-footer" id="ad-modal_footer">
        <button type="button" class="red_button" href="">Apply</button>
        </div>
    </div>
    </div>
</div>