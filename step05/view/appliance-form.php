...
<button id='launchApplyModal' class="red_button" type="button" data-bs-toggle="modal" data-bs-target="#applyModal">
    Open apply modal
</button>
...
<script>
    document.addEventListener('DOMContentLoaded', function(){
        ...
        var myInput = document.getElementById('launchApplyModal')
